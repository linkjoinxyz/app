function syncAuth() {
    ...
    // The refresh token comes across too: access tokens are short-lived and this
    // worker runs between page visits, so without it the extension silently
    // stops working until the next visit.
