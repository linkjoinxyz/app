      ...
      <main className="pp-main">
        <div className="pp-body">
          ...
          <section className="pp-section">
            <h2>3. Accounts</h2>
            <p>
              You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. You agree to notify us immediately via our <a href="/contact" style={{color:'inherit'}}>contact form</a> if you suspect unauthorized access. We are not liable for any loss or damage arising from your failure to protect your credentials.
            </p>
            <p>
          ...
          <section className="pp-section">
            ...
            <p>
              You may stop using the Service and delete your account at any time by <a href="/contact" style={{color:'inherit'}}>contacting us</a>. We may suspend or terminate your access to the Service immediately, without prior notice, for conduct that we determine violates these Terms or is harmful to other users, us, or third parties.
            </p>
            <p>
