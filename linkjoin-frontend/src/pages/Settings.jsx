    ...
    <div className="settings-root">
      ...
      {toast && (
        <div className={`settings-toast ${toast}`}>
          {toast === 'saved'
            ? <><svg width="12" height="12" viewBox="0 0 24 24" fill="none"><path d="M5 13l4 4L19 7" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg> Saved</>
            : <><svg width="12" height="12" viewBox="0 0 24 24" fill="none"><path d="M18 6L6 18M6 6l12 12" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/></svg> Failed to save</>
          }
        </div>
      )}
